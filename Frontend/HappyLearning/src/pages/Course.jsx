...
const Course = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      handleCancel(); // Optionally close the modal on successful submission
    }
  };
  ...
  return (
    <div className="container mt-5">
      ...
      <header className="mb-5 text-center">
        ...
        <p>Enhance your skills with our comprehensive and carefully curated courses.</p>
      </header>
        ...
        <div className="col-md-6">
          <div className="text-content">
            <p className="description">
              Our institute is dedicated to providing top-notch education that empowers students to excel in the rapidly evolving tech industry. 
              With a curriculum designed by industry experts, we ensure that our courses are not only relevant but also impactful. 
              Whether you're looking to start a new career, upgrade your skills, or explore new technologies, our courses offer a transformative 
              learning experience. Our state-of-the-art classrooms, experienced faculty, and hands-on approach ensure that you gain practical 
              knowledge that is immediately applicable in the real world.
            </p>
            <p className="cta">
              If you're eager to elevate your career and want to learn more about how our institute can help you achieve your goals, 
              we invite you to enroll or contact us today.
            </p>
          </div>
        </div>
        <div className="col-md-6">
        ...
        <div className="enroll-modal">
          <div className="enroll-modal-content">
            <div className="modal-header">
              <h2 className="text-center">Get this Course @ ₹{selectedCourse.price}</h2>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="modal-footer">
                <button type="submit" className="btn btn-success w-100">Enroll</button>
              </div>
            </form>
          </div>
        </div>
