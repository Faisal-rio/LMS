        ...
        <div className="contact-us-container">
            <div className="contact-details">
                ...
                <div className="contact-info lets-talk-info">
                    ...
                    <h4>Let's Talk</h4>
                    <p><a href="tel:+81001238741">+91 81001238741</a></p>
                </div>
                <div className="contact-info support-info">
                    <FontAwesomeIcon icon={faEnvelope} className="contact-icon" />
                    <h4>General Support</h4>
                    {/* Update the email link to use the 'mailto:' protocol */}
                    <p><a href="mailto:faisal.sfzubaida@gmail.com?subject=Support Request&body=Hello, I have a question about...">contact@gmail.com</a></p>
                </div>
            </div>

            <div className="contact-form">
                <h2>Send Us A Message</h2>
                {formSubmitted && <p className="success-message">Thank you! Your message has been sent.</p>}
